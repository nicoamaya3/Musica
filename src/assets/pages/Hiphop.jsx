    ...
    <>
       ...
       <div className="p-5 d-flex flex-column " style={{ backgroundImage: "url(./run.jpg)" }}>
        ...
        <div className="d-flex justify-content-center">
          <Recuadros nombre="AfrikaBambaataa" imagen="../public/afrikaa.jpg" />
          <Recuadros nombre="GrandMaster" imagen="../public/flash.jpg" />
          <Recuadros nombre="DjKoolHerc" imagen="../public/djk.jpg" />
        </div>
      </div>
